...
//---------------------------------
//- BR : Vinodh and Gagan were smart people. I was not able to leave my impression of being smart. I was only able to potray myself as
//       hardworking individual.
//- College: Same this happened in my college, where i was not able to solve puzzles in front of Rwr. In first year about ED etc.
...
//------------
//9/2008 - 7/2010
// I started with Cisco Systems in Bangalore in the year 2008. Instead of joining CDO, I joined Cisco Services Division which I believe was not the
// topmost division.
// For two years, I just worked on NMS (Network management system). Learned Basic java, Wrote one multithreaded module for file scheduling.
// Nothing fancy.
// Learnt basics of Spring Webflow. I have had this peculiar habit of not able to finish any learning which I have desired. I became build expert.
// 2 years of basic learning and nothing much I would say.
//
//7/2010 - 12/2012
// I joined Microsoft WinSE group. The group used to fix bugs only. I spent 2.5 years working on Active Directory. I improved only on debugging
// and nothing much. From coding perspective, here I started doing CodeChef and got little good experience. In coding world, I was not able to
// establish anything substantial. I tried to appear in interviews in Facebook, but not able to gave in December 2012.
// (In July 2012 two of my team mates Gautam and Srinidhi joined Facebook just after IPO).
// Subsequently Ashish Pant joined Google. I appeared in Google interview in the year 2012 November, and got rejected in Telephonic itself.
// I appeared in Amazon and got rejected in 2nd round itself in my first attempt, later I tried again second time in November 2012 but got rejected
// again (This time they asked my package and then rejected). I got offer from DirectI, Bloomreach and Vizury interactive (By cheating).
//
//1/2013 - 7/2014
...
//Learning wise I did learn basics of ADFS.  Coding and desining wise I did nothing. I appeared in Linkedin, Palantir, Uber, Pivotal, Cynogen,
//Groupon, Amazon, Yelp and Pinterest
//interview.
//
//
//
